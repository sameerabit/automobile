                    ...
                    <form class="needs-validation" id="insuranceForm" action="#">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="date" class="form-control" id="date" placeholder="Job Date" value="{{ $insuranceClaim->date }}">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" id="phone_2" name="phone_1" class="form-control" value="{{ $insuranceClaim->phone_2 }}">
                            </div>
                        </div>
                        <div class="row py-2">
