...
<div class="container">
    <div class="row">
        <div class="col-md-3 offset-md-9">
            <a class="btn btn-block btn-primary btn-lg" href="{{ route('roles.create') }}">Add Role</a>
        </div>
    </div>
    <div class="row py-2">
        <div class="col-md-12">
            ...
            <form action="{{ route('roles.index') }}">
                ...
                <div class="card-body">
                  <table class="table table-bordered" id="listTable">
                    ...
                    <tbody>
                      @foreach ($roles as $brand)
                      <tr>
                            <td>{{ $brand->id }}</td>
                            <td>{{ $brand->name }}</td>
                            <td class="d-flex">
                                <a class="btn btn-warning btn-sm m-auto" href="{{ route('roles.edit',$brand->id) }}"><i class="fas fa-edit"></i>Edit</a>
                                <form action="{{ route('roles.destroy',$brand->id) }}"
