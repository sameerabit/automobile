    ...
    <div class="container">
        <div class="row py-2">
            <div class="col-md-12">
                <div class="card">
                            <div class="row">
                                    <img  class="center" height="75px" width="200px" src="{{ asset('uploads/logo.jpg') }}" alt="">
                                    <p style="text-align:center">Amith Automobiles, 147/1, Bandaranayake Place, Thalapitiya, Galle</p>
                        ...
                        <div id="details">
                            ...
                            <table style="width:100%">
                                ...
                                <tfoot>
                                        ...
                                        <tr>
                                            <td colspan="4"  style="text-align:right;font-weight: bold;"><h4>Total:  {{ number_format($sales_cost + $service_cost,2) }}<h4></td>
                                        </tr>
                                </tfoot>
                            </table>
                        <div class="row py-2">
