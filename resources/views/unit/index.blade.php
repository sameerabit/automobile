...
<div class="container">
    <div class="row">
        <div class="col-md-3 offset-md-9">
            <a class="btn btn-block btn-primary btn-lg" href="{{ route('units.create') }}">Add Unit</a>
        </div>
    </div>
    <div class="row py-2">
        <div class="col-md-12">
                  ...
                  <table class="table table-bordered" id="listTable">
                    ...
                    <tbody>
                      ...
                      <tr>
                            ...
                            <td class="d-flex">
                                <a class="btn btn-warning btn-sm m-auto" href="{{ route('units.edit',$unit->id) }}"><i class="fas fa-edit"></i>Edit</a>
