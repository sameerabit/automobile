...
<div class="container">
    <div class="row">
        <div class="col-md-3 offset-md-9">
            <a class="btn btn-block btn-primary btn-lg" href="{{ route('insurance_companies.create') }}">Add Insurance Company</a>
        </div>
    </div>
    <div class="row py-2">
        <div class="col-md-12">
            <div class="card">
            <form action="{{ route('insurance_companies.index') }}">
                  ...
                  <table class="table table-bordered" id="listTable">
                    ...
                    <tbody>
                      ...
                      <tr>
                            ...
                            <td>{{ $company->phone }}</td>
                            <td class="d-flex">
                                <a class="btn btn-warning btn-sm m-auto" href="{{ route('insurance_companies.edit',$company->id) }}"><i class="fas fa-edit"></i>Edit</a>
